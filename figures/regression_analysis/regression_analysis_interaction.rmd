...
initial_reg_plot <- plot_model(initial_model, 
           ...
           title = "A. Encouragement of initial submissions",
           axis.lim = c(0.1, 10)) +
  theme_bw()
...
full.cov.labels = c("submission_year" = "Submission Year", 
               ...
               "author_reviewer_interactionFemale Author, All Women" = "Last author female - all rev. female",
               "author_reviewer_interactionFemale Author, Mixed" = "Last author female - mixed rev.",
               "author_reviewer_interactionMale Author, All Men" = "Last author male - all rev. male",
               "author_reviewer_interactionMale Author, All Women" = "Last author male - all rev. female",
...
#cat(paste(out, collapse = "\n"), "\n", file="~/Desktop/full_model.txt", append=F)
#out
...
full_reg_plot <- plot_model(full_model, 
           ...
           wrap.labels = 100, # basically, don't wrap the labels, squeeze them all in
           title = "B. Acceptance of full submissions",
           axis.lim = c(0.1, 10)) +
  theme_bw()
...
ggsave(name, plot = regressions_interactions, height = 8, width = 10)
```