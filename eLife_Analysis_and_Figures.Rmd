...
ggsave("figures/main/fig_6.png", plot = fig6, height = 6, width = 8)
```
...
fig_SI.2 <- elife %>%
  ...
  mutate(
    author_key = factor(author_key,
                        levels = c("ca_gender", "fa_gender", "la_gender"),
                        labels = c("ca_gender" = "Corr. Author", "fa_gender" = "First Author", "la_gender" = "Last Author")
                        ),
    measure_key = factor(measure_key, 
                         labels = c("submit_rate" = "Submissions", "encourage_rate" = "Enc %", "accept_rate" = "Overall Acc %", "encourage_accept_rate" = "Accept %"),
                         levels = c("submit_rate", "encourage_rate", "accept_rate", "encourage_accept_rate")),
...
ggsave("figures/supp/fig_SI4.tiff", plot = fig_SI.4, height = 4, width = 7)
ggsave("figures/supp/fig_SI4.png", plot = fig_SI.4, height = 4, width = 7)
```
